...
/** Count revenue from paid orders or fulfilled (delivered) orders — excludes cancelled/refunded. */
...
export const getDashboardStats = async (
  ...
  try {
    ...
    const monthlyRevenueTrends = buildMonthlyRevenueTrends(
...
export const getSalesReport = async (
  ...
  try {
    ...
    const safeGroupBy = VALID_GROUP_BY.has(groupBy as string)
      ? (groupBy as string)
      : "day";
