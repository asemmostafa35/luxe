  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md animate-fade-up">
        ...
        <h1 className="font-serif text-4xl font-light text-brand-900 dark:text-white mb-3">
          Order Placed!
        </h1>
        <p className="text-brand-600 dark:text-brand-400 mb-2">
          Thank you for shopping with ZANE.
        </p>
        {order && (
          <p className="text-sm text-brand-500 mb-2">
            Order number:{" "}
            <span className="font-medium text-brand-900 dark:text-white font-mono">
              {order}
            </span>
          </p>
        )}
        <p className="text-sm text-brand-500 mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          {order && (
            <Link
              href={`/order-tracking?order=${order}`}
